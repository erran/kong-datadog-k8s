...
local DatadogK8sHandler    = BasePlugin:extend()
DatadogK8sHandler.PRIORITY = 10
DatadogK8sHandler.VERSION = "0.1.0"
...
function DatadogK8sHandler:new()
  DatadogK8sHandler.super.new(self, "datadog-k8s")
end

function DatadogK8sHandler:log(conf)
  DatadogK8sHandler.super.log(self)
